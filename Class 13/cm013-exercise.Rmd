...
1. plot is readable (cluttered)
2. all text readable
3. visually appealing
4. aesthetics help understand, not create confusion
5. type of plot is appropriate for data being shown
...
- Weak. The plot shows that German workers work more but we can't assume it's because they are more motivated.

- The x-axis can be misleading; if starting at 0, see virutally no difference between the countries.
...
- Do not know. The graph does not make good use of space and so the trend of the line is hard to see.

- Not always good to start axis at 0. Year not labeled.
...
- Very weak. There were reduced deaths prior to the legislation. The y-axis is reversed?

- The plot is misleading because the y-axis is upside down. When fixed, can see number of deaths increased.
...
- left y axis is % (0 to .6)
- right y axis is 86 to 95
- significant difference in scale between the autism prevalence and mmr coverage
...
2. Maintain high data-to-ink ratio
3. Always update axes labels and titles on your plots
4. Choose scale and graph-type carefully
5. Choose colours with accessibility and readability in mind

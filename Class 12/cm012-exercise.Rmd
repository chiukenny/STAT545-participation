...
levels(gapminder$continent) # 5; "Africa","Americas","Asia","Europe","Oceania'
...
```{r}
nlevels(gapminder$country) # 142
gapminder %>%
  filter(country == "Canada" | country == "France" | country == "England" | country == "Taiwan" | country == "China") %>%
  mutate(factor(country, levels = c("Canada", "France", "England", "Taiwan", "China"))) %>%
  nlevels()
